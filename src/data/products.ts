...
export const products: Product[] = [
  {
    ...
    tag: "Most Popular",
    description:
      "Complete end-to-end E-2 visa strategy including business plan, financial projections, and go-to-market framework. Our flagship package.",
    details: [
      "Comprehensive E-2 business plan",
  ...
  },
  {
    ...
    tag: "Essential",
    description:
      "A meticulously crafted business plan tailored to E-2 visa requirements and your specific industry vertical.",
    details: [
  ...
  },
  {
    ...
    tag: "Starter",
    description:
      "Essential business documentation bundle prepared to consulate standards — ideal for straightforward E-2 applications.",
    details: [
  ...
  },
  {
    ...
    tag: "Self-Service",
    description:
      "Pre-built, E-2-optimized financial model template. Plug in your numbers and generate consulate-ready projections.",
    details: [
      "Plug-and-play Excel template",
      "Built-in formulas",
      "E-2 visa compliance checks",
  ...
  },
  {
    ...
    tag: "Essentials",
    description:
      "We build a foundational financial model for your business — clean, clear, and ready for your visa application.",
    details: [
      "Revenue model setup",
      "Expense framework",
      "Basic projections",
  ...
  },
  {
    ...
    tag: "Premium",
    description:
      "Complete EB-2 National Interest Waiver petition package — from eligibility assessment to evidence compilation and I-140 filing strategy.",
    details: [
      "NIW eligibility assessment",
      "Prong-by-prong case strategy",
  ...
  },
  {
    ...
    tag: "Strategy",
    description:
      "Focused evidence compilation for EB-2 NIW petitions — demonstrating substantial merit, national scope, and that a waiver is in the national interest.",
    details: [
