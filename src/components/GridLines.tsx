  ...
  return (
    <div className="fixed inset-0 z-[1] pointer-events-none" aria-hidden="true">
      ...
      <div className="max-w-7xl mx-auto h-full px-6 md:px-12 flex justify-between">
        <div className="w-px h-full bg-black/[0.025]" />
        <div className="w-px h-full bg-black/[0.025] hidden md:block" />
        <div className="w-px h-full bg-black/[0.025] hidden lg:block" />
        <div className="w-px h-full bg-black/[0.025] hidden lg:block" />
        <div className="w-px h-full bg-black/[0.025]" />
      </div>
    </div>
