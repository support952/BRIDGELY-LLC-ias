...
const Hero = memo(function Hero() {
  ...
  return (
    <section className="force-dark relative min-h-[100svh] flex items-center justify-center overflow-hidden bg-dark">
      {/* Background image */}
      <Image
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-5 sm:px-6 md:px-12 text-center py-20 sm:py-28 md:py-32">
        ...
        >
          <a
            href="#contact"
            className="group w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-accent text-dark text-[12px] sm:text-[13px] uppercase tracking-[0.2em] px-8 sm:px-10 py-3.5 sm:py-4 font-medium hover:bg-accent-muted hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 transition-colors duration-300"
          >
            Book a Consultation
          ...
          <a
            href="#visas"
            className="inline-flex items-center justify-center gap-3 text-[12px] sm:text-[13px] uppercase tracking-[0.2em] text-white border border-white/40 px-8 sm:px-10 py-3.5 sm:py-4 hover:bg-white/10 hover:border-white/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 transition-all duration-300"
          >
