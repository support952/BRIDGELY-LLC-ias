  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 0%, var(--color-accent-subtle) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="relative h-32 sm:h-40 flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            background: "radial-gradient(ellipse at 50% 60%, var(--color-accent-subtle) 0%, transparent 70%)",
          }}
        />
        <div
      ...
      <div className="relative p-4 sm:p-6 pb-0 flex-1 flex flex-col">
        <div className="flex items-center justify-between mb-3 sm:mb-4 gap-2">
          <span className="text-[9px] sm:text-[10px] uppercase tracking-[0.2em] text-body truncate">
            {product.category}
          </span>
        ...
        <div className="flex items-baseline gap-1 mb-3 sm:mb-4">
          <span className="text-[10px] sm:text-[11px] text-body uppercase tracking-wider">From</span>
        ...
        <div className="flex-1">
          ...
          <button
            ...
            className="text-[10px] sm:text-[11px] uppercase tracking-[0.2em] text-body hover:text-heading transition-colors duration-300 mb-3 sm:mb-4"
          >
      ...
      {product.featured && (
        <div className="absolute -top-px -right-px">
          <div className="bg-accent text-white text-[8px] sm:text-[9px] uppercase tracking-[0.2em] font-medium px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-bl-lg rounded-tr-lg">
            Featured
          </div>
        </div>
      )}
